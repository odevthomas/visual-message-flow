      ...
      <div className="container mx-auto max-w-4xl text-center relative z-10">
        ...
        >
          <button
            ...
            className="flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-green-600 to-emerald-700 text-white text-lg sm:text-xl font-semibold rounded-xl shadow-lg hover:scale-105 hover:shadow-2xl transition-all duration-300"
          >
          ...
          <button
            onClick={handleWhatsAppClick}
            className="flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-gray-800 hover:bg-gray-700 text-white text-lg sm:text-xl font-semibold rounded-xl shadow-lg hover:scale-105 hover:shadow-2xl transition-all duration-300"
          >
            Solicitar Orçamento
          </button>
        </motion.div>
