    ...
    <section className='py-16 sm:py-20 md:py-24 relative overflow-hidden'>
      ...
      <div className='container mx-auto px-4 sm:px-6 relative z-20 text-center'>
        <h2 className='text-3xl sm:text-4xl md:text-5xl font-bold text-gray-800 mb-4'>
          Empresas que confiam na nossa equipe
        </h2>
        <p className='text-gray-600 text-lg sm:text-xl max-w-2xl mx-auto mb-12'>
          Mais de 2.000 clientes já contam com nossos contratos de manutenção
          para garantir o funcionamento de seus equipamentos com segurança e
          eficiência.
        </p>
        ...
        <Marquee duration={35}>
          {clients.map((client, index) => (
            <div
              key={index}
              className='flex-shrink-0 w-40 sm:w-52 md:w-64 h-32 sm:h-40 md:h-48 flex items-center justify-center px-4 py-2 relative group'
            >
