    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        {[...Array(6)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute w-1.5 h-1.5 sm:w-2 sm:h-2 bg-gray-500 rounded-full opacity-20"
            style={{
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-3xl relative z-10">
        ...
        >
          <div className="backdrop-blur-lg bg-white/5 border border-white/10 rounded-3xl p-6 sm:p-8 md:p-10 shadow-xl max-w-md mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <motion.button
                ...
                className="inline-flex items-center justify-center px-5 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-green-600 to-emerald-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden"
              ...
              <motion.button
                ...
                className="inline-flex items-center justify-center px-5 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-gray-600 to-gray-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
                Ligar Agora
