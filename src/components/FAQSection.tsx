      ...
      <div className="space-y-3">
        ...
        <div className="bg-blue-50 p-4 rounded-lg space-y-2">
          <div className="flex items-start gap-3">
            ...
            <p><strong>Entre em contato:</strong> Ligue ou mande WhatsApp informando o problema do equipamento</p>
          </div>
          <div className="flex items-start gap-3">
            ...
            <p><strong>Triagem inicial:</strong> Nossa equipe identifica a situação e agenda a melhor data</p>
          </div>
          <div className="flex items-start gap-3">
            ...
            <p><strong>Visita técnica:</strong> Técnico especializado vai até seu local com rapidez e praticidade</p>
          </div>
        </div>
      </div>
    ),
      ...
      <div className="space-y-4">
        <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
          <div className="flex items-start gap-2 mb-2">
            ...
            <div>
              <p className="font-bold text-green-800 text-lg">Serviços em geral</p>
              <p className="text-green-700">90 dias de garantia legal em todos os reparos realizados</p>
            </div>
          </div>
        </div>
        <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
          <div className="flex items-start gap-2">
            ...
            <div>
              <p className="font-bold text-blue-800 text-lg">Troca de compressor</p>
              <p className="text-blue-700">Garantia do serviço + 1 ano de garantia do fabricante no compressor</p>
            </div>
          </div>
        </div>
        <p className="text-sm text-gray-600 italic">Você está 100% protegido com nossa garantia!</p>
      </div>
    ),
  },
  {
    ...
    answer: (
      <div className="space-y-4">
        <p className="font-semibold text-gray-800">Aceitamos diversas formas de pagamento para sua comodidade:</p>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-5 rounded-xl mt-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-blue-100">Clientes corporativos com cadastro têm acesso a pagamento via boleto bancário e condições especiais</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-5 rounded-xl">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between border-b border-blue-400 pb-2">
              ...
              <span className="bg-white text-blue-600 px-3 py-1 rounded-full text-sm font-bold">08h - 17h</span>
            </div>
            <div className="flex items-center justify-between border-b border-blue-400 pb-2">
              <span className="font-semibold">Sábado</span>
              <span className="bg-white text-blue-600 px-3 py-1 rounded-full text-sm font-bold">08h - 12h</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="font-semibold">Domingos e Feriados</span>
              <span className="bg-red-500 text-white px-3 py-1 rounded-full text-sm font-bold">Fechado</span>
            </div>
          </div>
        </div>
        <p className="text-center text-sm text-gray-600">⚡ Atendimento emergencial disponível em casos urgentes</p>
      </div>
    ),
  },
  {
      ...
      <div className="space-y-4">
        <div className="bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-300 p-5 rounded-xl">
          <div className="flex items-start gap-3 mb-3">
            ...
            <div>
              <p className="font-bold text-green-800 text-lg mb-2">Como funciona:</p>
              <p className="text-gray-700">Um técnico especializado vai até você, avalia o equipamento com cuidado e apresenta um orçamento completo e transparente - sem nenhum compromisso!</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-yellow-50 border-2 border-yellow-300 p-5 rounded-xl">
          ...
          <div className="space-y-2 text-gray-700">
            <div className="flex items-start gap-2">
              ...
              <p><strong>Orçamento não aprovado:</strong> Cobra-se apenas a taxa de visita</p>
            </div>
            <div className="flex items-start gap-2">
              <CheckCircle className="text-green-500 flex-shrink-0 mt-0.5" size={18} />
              <p><strong>Orçamento aprovado:</strong> Taxa de visita GRÁTIS - você não paga nada!</p>
            </div>
          </div>
        </div>
        
        <p className="text-center text-sm text-gray-500 italic bg-gray-100 p-3 rounded-lg">
          💡 Consulte o valor da taxa de visita para o seu endereço com nossa equipe
        </p>
      </div>
    ),
  },
          ...
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                ...
                <div className={`flex-shrink-0 p-1.5 md:p-2 rounded-full transition-all ${
                  openIndex === index ? 'bg-blue-500 rotate-180' : 'bg-gray-200'
                }`}>
                  {openIndex === index ? (
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-0">
          <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl relative">
            ...
            <div className="grid md:grid-cols-5 gap-0 relative z-10">
              ...
              <div className="md:col-span-3 p-6 sm:p-8 md:p-10 lg:p-14">
                <div className="inline-flex items-center gap-2 bg-yellow-400 text-blue-900 px-3 sm:px-4 md:px-5 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-bold mb-4 sm:mb-5 md:mb-6">
                  ...
                  <span className="whitespace-nowrap">ATENDIMENTO EMERGENCIAL 24H</span>
                </div>
                ...
                <p className="text-base sm:text-lg md:text-xl mb-6 sm:mb-7 md:mb-8 text-blue-100 leading-relaxed">
                  Técnicos especializados em Campinas e região. Atendimento rápido, orçamento transparente e garantia de qualidade que você merece.
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-7 md:mb-8">
                  <div className="flex items-center gap-2 sm:gap-3 bg-white/10 backdrop-blur-sm p-3 sm:p-4 rounded-lg sm:rounded-xl">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100 text-xs sm:text-sm">Até 24h</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2 sm:gap-3 bg-white/10 backdrop-blur-sm p-3 sm:p-4 rounded-lg sm:rounded-xl">
                    <div className="bg-white/20 p-2 sm:p-3 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100 text-xs sm:text-sm">Certificados</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2 sm:gap-3 bg-white/10 backdrop-blur-sm p-3 sm:p-4 rounded-lg sm:rounded-xl">
                    <div className="bg-white/20 p-2 sm:p-3 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100 text-xs sm:text-sm">90 dias</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2 sm:gap-3 bg-white/10 backdrop-blur-sm p-3 sm:p-4 rounded-lg sm:rounded-xl">
                    <div className="bg-white/20 p-2 sm:p-3 rounded-lg">
                    ...
                    <div>
                      <p className="font-bold text-xs sm:text-sm">Especialistas</p>
                      <p className="text-blue-100 text-xs sm:text-sm">Em refrigeração</p>
                    </div>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full bg-green-500 hover:bg-green-600 text-white font-bold px-6 sm:px-8 md:px-10 py-4 sm:py-5 md:py-6 rounded-xl md:rounded-2xl shadow-2xl transition-all duration-300 flex items-center justify-center gap-2 sm:gap-3 text-base sm:text-lg md:text-xl group transform hover:scale-105"
                >
                  <svg 
                  ...
                  <span className="text-center">Agendar Visita pelo WhatsApp</span>
                </button>

                <p className="text-center text-sm sm:text-base text-blue-200 mt-4 sm:mt-5 flex items-center justify-center gap-1.5 sm:gap-2">
                  <MapPin size={16} className="sm:w-[18px] sm:h-[18px] flex-shrink-0" />
                  <span>Campinas e região metropolitana</span>
                </p>
              </div>

              {/* Lado Direito - Imagem/Visual (2/5) */}
<div className="relative md:col-span-2 hidden md:flex items-center justify-center min-h-[400px] lg:min-h-[500px] xl:min-h-[600px] bg-gradient-to-br from-blue-500/10 to-transparent p-4">
    <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 to-transparent"></div>
    <img
      src={geladeira}
      alt="Imagem de Geladeira"
    ...
    />
        ...
        <div className="text-center mt-12 sm:mt-14 md:mt-16 space-y-3 sm:space-y-4 px-4">
          <div className="inline-flex items-center gap-2 sm:gap-3 bg-green-50 text-green-800 px-4 sm:px-6 md:px-8 py-3 sm:py-3.5 md:py-4 rounded-xl md:rounded-2xl border-2 border-green-200 shadow-md">
            ...
            <span className="font-bold text-sm sm:text-base md:text-lg">Empresa verificada com 15+ anos de experiência</span>
          </div>
          <p className="text-gray-500 text-xs sm:text-sm">Confiança e qualidade garantidas em cada atendimento</p>
        </div>
      </div>
    </section>
  );
